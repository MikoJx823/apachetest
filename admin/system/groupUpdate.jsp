...
<%
    ...
    String gid = StringUtils.trimToEmpty(request.getParameter("gid"));
	...
	GroupInfoBean updateBean = (GroupInfoBean)request.getAttribute("groupInfoBean");
	if(updateBean != null){
		groupInfoBean = updateBean;
	}
...
<jsp:include page="../main/adminHeader.jsp"></jsp:include>
  ...
  <div class="panel-heading"><big>Edit User Access Group</big></div>
  ...
  <div class="panel-body">
	...
	<h5 class="text-primary">User Access Group Information</h5>
       ...
       <div class="row">
        ...
        <div class="col-xs-8">
          <div class="form-group">
            ...
            <input class="form-control" id="groupName" name="groupName"  autocomplete="off" value="<%=StringUtils.trimToEmpty(groupInfoBean.getGroupName()) %>">
          </div>
      </div><!--col-xs-8-->
       </div><!--row end-->
       ...
       <div class="row">
        ...
        <div class="form-group">
        <label>Desc </label>
            <textarea class="form-control" id="description" name="description"  autocomplete="off" ><%=StringUtils.trimToEmpty(groupInfoBean.getDescription()) %></textarea>
       </div>
       </div><!--col-xs-8-->
       </div>
  ...
  <a href="../system/groupIdx.jsp" class="btn btn-cancel loginbtn hvr-float-shadow">Back</a>
  </div>
