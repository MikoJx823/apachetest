...
<%
	...
	String name = StringUtil.trimToEmpty(request.getSession().getAttribute("loginName"));
	String loginId = StringUtil.trimToEmpty(request.getSession().getAttribute("loginId"));
	String gid = StringUtil.trimToEmpty(request.getSession().getAttribute("gid"));
	int status = StringUtil.strToInt(StringUtil.trimToEmpty(request.getSession().getAttribute("status")));
