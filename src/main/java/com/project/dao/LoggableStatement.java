...
public class LoggableStatement implements PreparedStatement
{
	...
	public LoggableStatement(Connection connection, String sql) throws SQLException
	{
		...
		wrappedStatement = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
		sqlTemplate = sql;
	...
	{
		String strValue;
		if (obj instanceof String || obj instanceof Date || obj instanceof java.util.Date || obj instanceof java.sql.Timestamp)
		{
	...
	// è¿™ä¸€æ­¥æ˜¯å¯¹ArrayListä¸Žsqlè¿›è¡Œå¤„ç�†ï¼Œè¾“å‡ºå®Œæ•´çš„sqlè¯­å�¥
