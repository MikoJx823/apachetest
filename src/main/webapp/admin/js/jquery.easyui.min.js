...
_b30(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_b45){
...
return $(_b49).datebox("options").cleanText;
},handler:function(_b50){
$(_b50).combo('setValue', '').combo('setText', '');  
