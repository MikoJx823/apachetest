						...
						<div class="col-md-6">
							...
							<div class="billing-field">
								...
								<div class="row">
									...
									<div class="form-group col-sm-6">
										<div class="required">
											<input type="tel" class="form-control" placeholder="Phone" name="contact" id="contact" required>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="required">
										<input type="text" class="form-control" placeholder="Postcode / ZIP" name="postcode" id="postcode" required>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group col-sm-6">
										<div class="required">
											<input type="text" class="form-control" placeholder="Town / City" name="town" id="town" required>
										</div>
									</div>
									<div class="form-group col-sm-6">
										<div class="required">
								...
								<div class="form-group">
									<h3>
										<input type="checkbox" id="ship-different-address" name="shipdifferent" id="shipdifferent" value="<%=StaticValueUtil.STATUS_YES %>" >
									...
									<div class="different-address box" style="display: none;">
										<div class="row">
											<div class="form-group col-sm-6">
												<div class="required">
													<input type="text" class="form-control" placeholder="First Name" name="shipfirstname" id="shipfirstname" required>
												</div>
											</div>
											<div class="form-group col-sm-6">
												<div class="required">
													<input type="text" class="form-control" placeholder="Last Name" name="shiplastname" id="shiplastname" required>
												</div>
											</div>
										</div>

										<div class="form-group">
											<input type="text" class="form-control" placeholder="Company Name" name="shipcomanyname" id="shipcomanyname">
										</div>
										...
										<div class="row">
											<div class="form-group col-sm-6">
												<div class="required">
													<input type="text" class="form-control" placeholder="Address" name="shipaddress" id="shipaddress" required>
												</div>
											</div>
											<div class="form-group col-sm-6">
												<input type="text" class="form-control" placeholder="Address 2" name="shipaddress2" id="shipaddress2">
											</div>
										</div>

										<div class="form-group">
											<div class="required">
												<input type="text" class="form-control" placeholder="Postcode / ZIP" name="shippostcode" id="shippostcode" required>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col-sm-6">
												<div class="required">
													<input type="text" class="form-control" placeholder="Town / City" name="shiptown" id="shiptown" required>
												</div>
											</div>
											<div class="form-group col-sm-6">
												<div class="required">
								...
								<div class="form-group">
									...
									<textarea class="form-control" placeholder="Notes about your order, e.g. special notes for delivery." rows="5" name="remark" id="remark"></textarea>
								</div>
							</div><!-- /.billing-field -->
						</div>
