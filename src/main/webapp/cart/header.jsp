				    ...
				    <ul class="nav navbar-nav navbar-left"> 
				        ...
				        <li style="min-width:80px;text-align:center;"> <!-- class="active" -->
				            <a href="index.html" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false" style="color:white"><%=StringUtil.filter(parent.getName()) %> </a>
				           	<div class="mega-dropdown1 dropdown-menu" style="left:-80px;">
				                ...
				                <li class="topmenu-subcat"><span onClick="javascript:window.location.href='https://www.google.com'"><%=StringUtil.filter(category.getName()) %></span>  </li> <!-- class="active" -->
				        ...
				        <li style="min-width:80px;text-align:center;">
				            <a href="index.html" data-toggle="dropdown" aria-haspopup="false" aria-expanded="false" style="color:white"><%=StringUtil.filter(parent.getName()) %> </a>
				           	<div class="mega-dropdown2 dropdown-menu" style="left:-180px;">
				           		...
				           		<li class="topmenu-subcat"><span onClick="javascript:window.location.href='https://www.google.com'"><%=StringUtil.filter(cat.getName()) %></span>  </li>
				        ...
				        <li style="min-width:80px;text-align:center;">
				            ...
				            <div class="mega-dropdown3 dropdown-menu" style="left:-280px;">
				           		<ul class="mega-subcontent">
				           		<li class="topmenu-subcat"><strong><span onClick="javascript:window.location.href='https://www.google.com'">FEATURED OF THE MONTH</span></strong>  </li>
				           		<!--<li><a href="index.html">FEATURED OF THE MONTH</a></li> <!-- class="active" -->
				         		</ul>
				         		<ul class="mega-subcontent">
				         		<li class="topmenu-subcat"><strong><span onClick="javascript:window.location.href='https://www.google.com'">VALUE BUNDLE</span></strong>  </li>
				           		<!--<li><a href="index.html">VALUE BUNDLE</a></li> <!-- class="active" -->
				         		</ul>
				         		<ul class="mega-subcontent">
				         		<li class="topmenu-subcat"><strong><span onClick="javascript:window.location.href='https://www.google.com'">OUR TOP 10</span></strong>  </li>
				        ...
				        <li style="min-width:80px;text-align:center;">
				        	...
				        	<div class="mega-dropdown3 dropdown-menu" style="left:-390px;">
				           		<ul class="mega-subcontent">
				           		<li class="topmenu-subcat"><strong><span onClick="javascript:window.location.href='https://www.google.com'">TUTORIAL</span></strong>  </li>
				           		<!--<li><a href="index.html"><strong>TUTORIAL</strong></a></li> <!-- class="active" -->
				         		</ul>
				         		<ul class="mega-subcontent">
				         		<li class="topmenu-subcat"><strong><span onClick="javascript:window.location.href='https://www.google.com'">CELERITIES CHOICES</span></strong>  </li>
				           		<!--<li><a href="index.html"><strong>CELERITIES CHOICES</strong></a></li> <!-- class="active" -->
				         		</ul>
				         		<ul class="mega-subcontent">
				         		<li class="topmenu-subcat"><strong><span onClick="javascript:window.location.href='https://www.google.com'">VIDEO</span></strong>  </li>
